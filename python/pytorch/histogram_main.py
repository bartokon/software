...
from histogram_dataset import ModelNet40_n3
...
if __name__=="__main__":
    ...
    for iterz in range(0, 100):
        max_rot = random.randint(0, 45)
        ...
        if (isfile(f"models/model_gcn_50.pt")):
            model = torch.load(f"models/model_gcn_50.pt")
        else:
            model = FullNet()
        model.to('cuda')
